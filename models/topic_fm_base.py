"""
Topic FM Model — Flow Matching variant of TopicODEModel

Identical base behavior to TopicODEModel (VAE with logistic-normal prior)
plus conditional flow matching in pre-softmax R^K space for latent smoothing
and structured prior learning.

Single-phase training:
- Phase 1: Train VAE-based topic model with optional flow matching loss
...
try:
    ...
    from models.topic_base import TopicAutoEncoder
    from models.topic_flow_matching import TopicFlowMatchingMixin


class TopicFMModel(TopicFlowMatchingMixin, PriorMixin, ReconstructionLossMixin, BaseModel):
    """Topic model with flow matching in pre-softmax R^K space.

    Combines a VAE-based topic model (identical to TopicODEModel) with
    conditional flow matching for latent space regularization and smoothing.
    ...
    def __init__(
        ...
        # Initialize autoencoder (same as TopicODEModel)
        ...
        # Priors: logistic-normal approximation of Dirichlet (same as TopicODEModel)
    ...
    def compute_loss(
        ...
        **kwargs,
        ...
        Same as TopicODEModel loss computation but with an additional
        ...
        # Reconstruction loss (same as TopicODEModel)
        ...
        # KL divergence with free bits (same as TopicODEModel)
    ...
    def fit(
        ...
        **kwargs,
        ...
        """Train VAE-based topic model with flow matching.

        Same training loop as TopicODEModel but additionally:
        ...
        for epoch in range(epochs):
            ...
            for batch in train_loader:
                ...
                loss.backward()
                # Gradient clipping (same as TopicODEModel)
            ...
            if do_print:
                ...
                print(
                    f"Epoch {epoch+1:3d}/{epochs} [TopicFM] | "
